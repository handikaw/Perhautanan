...
<head>
    ...
    <title>Login &middot; Perhutani</title>
    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-md border border-bark-100 overflow-hidden">
            ...
            <div class="bg-canopy-800 px-8 py-5">
                ...
                <p class="text-canopy-200 text-sm mt-1">Masukkan kredensial untuk mengakses dashboard</p>
            </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div class="flex items-center">
                        <input
                            ...
                            type="checkbox"
                            name="remember"
                            class="w-4 h-4 text-canopy-700 border-bark-300 rounded focus:ring-canopy-500"
                        >
                        <label for="remember_me" class="ml-2 text-sm text-bark-600">
                    ...
                    <div class="flex flex-col space-y-3 pt-1">
                        ...
                        @if (Route::has('password.request'))
                            <a
                                ...
                                class="text-center text-sm text-canopy-700 hover:text-canopy-900 font-medium transition duration-200"
                            >
            ...
            <div class="bg-mist px-8 py-4 border-t border-bark-100">
                <p class="text-center text-sm text-bark-600">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="text-canopy-700 hover:text-canopy-900 font-semibold transition duration-200">
        ...
        <div class="text-center mt-6 text-xs text-bark-500">
            <p><i class="fas fa-shield-halved text-canopy-600 mr-1"></i>Sistem keamanan terenkripsi</p>
        </div>
