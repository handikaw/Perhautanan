...
<head>
    ...
    <title>Lupa Password &middot; Perhutani</title>
    ...
    <div class="max-w-md w-full">
        ...
        <div class="bg-white rounded-md border border-bark-100 overflow-hidden">
            ...
            <div class="bg-canopy-800 px-8 py-5">
                ...
                <p class="text-canopy-200 text-sm mt-1">Kami akan kirimkan tautan untuk mengatur ulang password Anda</p>
            </div>

            <!-- Card Body -->
            <div class="px-8 py-8">

                <p class="text-sm text-bark-600 leading-relaxed mb-6">
                    {{ __('Lupa password Anda? Tidak masalah. Cukup masukkan alamat email Anda dan kami akan mengirimkan tautan reset password agar Anda bisa membuat password baru.') }}
                </p>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
                    ...
                    <div class="flex items-center justify-between pt-1">
                        <a href="{{ route('login') }}" class="text-sm text-bark-600 hover:text-canopy-800 font-medium transition">
        ...
        <div class="text-center mt-6 text-xs text-bark-500">
            <p><i class="fas fa-shield-halved text-canopy-600 mr-1"></i>Tautan reset berlaku sementara demi keamanan akun Anda</p>
        </div>
