...
<body class="bg-mist min-h-screen font-body text-ink" style="background-image:radial-gradient(rgba(38,33,26,0.05) 1px, transparent 1px); background-size: 20px 20px;">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <section id="page-dashboard" class="page-section space-y-8">
            ...
            <div class="bg-white rounded-md shadow-sm border border-canopy-100 overflow-hidden">
                <div class="panel-header bg-canopy-800">
                    ...
                    <button onclick="switchPage('tambah-lahan')" class="no-print ml-auto bg-resin-500 hover:bg-resin-600 text-ink px-3 py-1.5 rounded-md font-semibold text-xs transition flex items-center space-x-1">
                    ...
                    <form method="POST" action="{{ route('forest.store') }}" class="space-y-6" id="addForm" onsubmit="return validateAddForm()">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                <button type="button" onclick="quickStatus('Konservasi', event)" class="status-quick-btn border-canopy-300 hover:border-canopy-500 bg-canopy-50">
                                ...
                                <button type="button" onclick="quickStatus('Produksi', event)" class="status-quick-btn border-bark-300 hover:border-bark-500 bg-bark-100/60">
                                ...
                                <button type="button" onclick="quickStatus('Reboisasi', event)" class="status-quick-btn border-resin-300 hover:border-resin-500 bg-resin-100/60">
                        ...
                        <div class="bg-canopy-50 border border-canopy-100 rounded-md p-4 text-xs text-canopy-700 flex items-start space-x-2">
                            ...
                            <span>Data langsung tampil pada Dashboard dan grafik Analisis Lahan setelah disimpan.</span>
                        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-md shadow-sm border-t-2 border-bark-500 p-6">
                        ...
                        <ul class="space-y-3 text-sm text-gray-600">
                            ...
                            <li class="flex items-start space-x-2"><i class="fas fa-check text-canopy-600 mt-0.5"></i><span>Detail penanggung jawab, koordinat, atau nomor izin bisa dicatat lewat menu Kegiatan Lahan setelah blok ini tersimpan.</span></li>
                        </ul>
                    </div>
        ...
        <section id="page-kegiatan" class="page-section hidden space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="no-print lg:col-span-1 bg-white rounded-md shadow-sm border-t-2 border-canopy-600 p-6">
                ...
                <div class="lg:col-span-2 space-y-4">
                    <div class="no-print bg-white rounded-md shadow-sm border border-canopy-100 p-4 flex flex-wrap gap-3 items-center">
        ...
        <section id="page-produksi" class="page-section hidden space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div class="no-print lg:col-span-1 bg-white rounded-md shadow-sm border-t-2 border-bark-500 p-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-md shadow-sm border-t-2 border-bark-500 p-6">
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <button onclick="downloadChart('produksiChart','tren-produksi')" class="no-print text-gray-400 hover:text-bark-600 transition" title="Unduh grafik"><i class="fas fa-download"></i></button>
                        </div>
